# Round 4: Cultural & Behavioral Interview

> 1 hour on Google Meet. This round assesses culture fit, collaboration, and leadership qualities.

## ShopBack's Core Values

Based on their culture and engineering practices:

1. **Customer Obsession** - Users and merchants come first
2. **Move Fast, Stay Scrappy** - Startup mentality despite scale
3. **Collaborate Across Boundaries** - BREW culture, cross-team work
4. **Own the Outcome** - End-to-end ownership
5. **Be Data-Driven** - Measure everything, experiment often
...
- Monitoring and how you detected bottlenecks
- Result: performance metrics, cost savings, reliability improvement
...
- How it turned out and what you'd do differently
...
- DevOps on infrastructure decisions
...
- Delegating challenging work to build others' skills
...
- What you delivered despite the change
...
- Interest in the APAC market and growth trajectory
- Specific things you've researched (BREW culture, multi-tenancy migration)
...
### Category 5: ShopBack-Specific Questions
...
- Testing strategy (market-specific edge cases)
- Monitoring per-market health
...
**Q: How do you balance speed of delivery with code quality?**

- Start with a clear definition of "good enough" for the context
- Automated quality gates (CI/CD, linting, tests)
- Code review as a quality mechanism
- Tech debt tracking and scheduled repayment
- Distinguish between prototype and production code
...
1. **Being too vague** - Use specific examples with numbers and outcomes
2. **Badmouthing previous employers** - Frame challenges as learning opportunities
3. **Not asking questions** - Prepare at least 3-4 thoughtful questions
4. **Monologuing** - Keep answers to 2-3 minutes max
5. **Being negative about constraints** - Show you work well within limits
6. **Not showing curiosity** - Ask follow-up questions about their challenges
