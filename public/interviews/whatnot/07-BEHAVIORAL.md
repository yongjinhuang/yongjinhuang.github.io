...
> 1 hour on Google Meet. This round assesses culture fit, collaboration, and alignment with Whatnot's principles.

## Whatnot's Cultural Principles
...
### Category 1: Move Fast / High Impact
...
- The outcome of focusing on the highest-impact work
...
- How did you manage technical debt afterward?

---

### Category 2: Ownership / "Figure It Out"
...
- The result of pushing through discomfort
...
- Impact: time saved, bugs prevented, revenue protected

---

### Category 3: Technical Leadership
...
- Result: performance metrics, reliability improvement
...
### Category 4: Collaboration & Feedback
...
- Show you give feedback because you care, not to be right
...
- Other engineering teams on integrations

---

### Category 5: Community / Product Sense
...
- Specific things you've noticed using the app
- Alignment with their culture (speed, ownership, high impact)
...
- Think about both buyer AND seller perspectives
...
- Define "good enough" for the context
- Automated quality gates (CI/CD, linting, tests)
- Distinguish prototype from production code
- Track and schedule tech debt repayment
- Ship fast, iterate toward quality
...
7. **Not knowing the product** - Download and use Whatnot before the interview
8. **Over-emphasizing perfection** - Whatnot values speed; show you ship fast
